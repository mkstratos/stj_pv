...
# -*- coding: utf-8 -*-
#
# STJ Metric documentation build configuration file, created by
...
htmlhelp_basename = 'STJMetricdoc'
...
man_pages = [
    (master_doc, 'stjmetric', 'STJ Metric Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'STJMetric', 'STJ Metric Documentation',
     author, 'STJMetric', 'One line description of project.',
     'Miscellaneous'),
]
