...
class Experiment(object):
    ...
    def PathFilenameERA(self):
        ...
        path = "{}{}".format(self.diri.data_loc, 'Data/ERA_INT/')
        self.u_fname = "{}{}".format(path, 'ERA_INT_UWind_correct_levels.nc')
        self.v_fname = "{}{}".format(path, 'vwind.nc')
        self.t_fname = "{}{}".format(path, 'ERA_int_temp.nc')
        self.path = path
